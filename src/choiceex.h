...
{
  public:
    ChoiceEx(FormGroup * parent, const rect_t &rect, int vmin, int vmax, std::function<int16_t()> getValue, std::function<void(int16_t)> setValue = nullptr, WindowFlags windowFlags = 0);
